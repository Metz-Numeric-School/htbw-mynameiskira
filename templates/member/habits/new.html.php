...
<div class="container py-5">
    ...
    <form action="/habits/create" method="post" class="mt-4">
        ...
        <div class="mb-3">
            ...
            <textarea name="habit[description]" id="habit_description" class="form-control"
                rows="3"><?= htmlspecialchars($_POST['habit']['description'] ?? '') ?></textarea>
        </div>
